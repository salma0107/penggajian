...
<head>
	...
	<style>
		...
		* {
		...
		.form-holder span.fas.fa-user {
			left: 9px;
		}

		.form-holder span.fas.fa-lock {
			left: 9px;
		}
        ...
        .register-link {
			...
			margin-top: 15px; /* Sesuaikan dengan jarak atas yang diinginkan */
		}
...
<div class="wrapper">
		<div class="inner">
		<!-- <img src="images/logoIPMS.png" class="logo"> -->
